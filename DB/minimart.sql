...
--
-- Host: localhost:3306
-- Generation Time: Jul 02, 2024 at 12:41 AM
...
CREATE TABLE `address` (
  ...
  `street` varchar(225) COLLATE utf8mb4_general_ci NOT NULL,
  `barangay` varchar(225) COLLATE utf8mb4_general_ci NOT NULL,
  `municipality` varchar(225) COLLATE utf8mb4_general_ci NOT NULL
...
CREATE TABLE `feedback` (
  ...
  `content` varchar(225) COLLATE utf8mb4_general_ci NOT NULL,
  `date_submitted` date NOT NULL,
  `ratings` varchar(225) COLLATE utf8mb4_general_ci NOT NULL,
  `user_id` int NOT NULL,
...
CREATE TABLE `orders` (
  ...
  `address_id` int NOT NULL,
  `user_id` int NOT NULL,
  `order_status` enum('Pending','ToShip','ToReceive','Completed') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'Pending',
  `delivery_option` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
(106, '2024-05-29 13:18:58', 360.00, 39, 31, 'ToReceive', 'delivery', '2024-05-29 21:18:58'),
(107, '2024-06-25 04:30:26', 3512.00, 39, 31, 'Pending', 'delivery', '2024-06-25 12:30:26'),
(115, '2024-06-25 04:40:58', 75.00, 39, 31, 'Pending', 'delivery', '2024-06-25 12:40:58'),
(116, '2024-06-25 04:45:40', 8.50, 39, 31, 'Pending', 'delivery', '2024-06-25 12:45:40'),
(117, '2024-07-01 23:27:27', 310.00, 39, 31, 'Pending', 'delivery', '2024-07-02 07:27:27');
...
(2, 4809010626332, 'Lemon Square Cheese cake 10x30g', 'Cheese Cake', 19, 'cheese-cake.png', '2024-05-10', 2),
(3, 5449000256805, 'Coke Mismo', 'Coke Mismo', 40, 'coke_mismo.png', '2024-05-10', 1),
...
(8, 4800110026497, 'Homi Instant Mami Noodles Beef Brisket 55g', 'HoMi Beef', 23, 'Homi_Beef.png', '2024-05-10', 4),
...
(12, 14800016057073, 'C2 Solo Green Tea Apple 230mlx24', 'C2 Apple', 6, 'c2_apple.png', '2024-05-10', 1),
...
(20, 4801981118519, 'Royal Mismo', 'Royal Mismo', 21, 'royal_mismo.png', '2024-05-10', 1),
...
(36, 4800130100016, 'Gsm Frasquito 350ml', 'Frasquito ', 46, 'Frasquito.png', '2026-08-20', 1),
...
(42, 4800016303159, 'Gffddfdfdf', 'Maxx Yellow', 21, 'bearbrand.jpeg', '2024-05-29', 10),
(43, 4800016303159, 'Sasdads', 'Maxx Yellow', 2, 'bearbrand.jpeg', '2024-05-29', 10);
...
CREATE TABLE `product_variations` (
  ...
  `variation_type` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
(1, 'shipping_fee', '200'),
(2, 'min_order_for_free_shipping', '1000');
...
CREATE TABLE `users` (
  ...
  `address_id` int NOT NULL,
  `verification_code` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
--
ALTER TABLE `address`
  MODIFY `address_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;

--
-- AUTO_INCREMENT for table `cart`
--
ALTER TABLE `cart`
  MODIFY `cart_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=199;
...
--
ALTER TABLE `orders`
  MODIFY `order_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=118;

--
-- AUTO_INCREMENT for table `orders_details`
--
ALTER TABLE `orders_details`
  MODIFY `orders_details_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=136;
...
--
ALTER TABLE `promo`
  MODIFY `promo_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `users`
  ADD CONSTRAINT `users_ibfk_1` FOREIGN KEY (`address_id`) REFERENCES `address` (`address_id`) ON UPDATE CASCADE;
COMMIT;
